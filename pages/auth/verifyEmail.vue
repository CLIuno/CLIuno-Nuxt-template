        ...
        <div class="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
            <div class="flex justify-center self-center z-10">
                <div class="p-12 bg-white mx-auto rounded-2xl w-100 ">
                    <div class="mb-4">
                        <h3 class="font-semibold text-2xl text-gray-800 text-center">Thanks for joining us!</h3>
                    </div>
                    <div class="flex items-center justify-center p-5 min-w-screen">
                        <div class="max-w-xl p-8 text-center text-gray-800 bg-white shadow-xl  rounded-3xl lg:p-12">
                            <div class="flex justify-center">
                                <svg class="w-32 h-32" viewBox="0 0 50 21" fill="none"
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear" x1="16.9996" y1="10.4791" x2="47.0156"
                                            y2="10.4791" gradientUnits="userSpaceOnUse">
                            ...
                            <h3>We're happy you're here. your account have been verified</h3>
                        </div>
                    </div>
